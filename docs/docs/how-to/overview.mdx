...
<CardGroup cols={2}>
  ...
  <Card title="Use ElevenLabs for STT and TTS" icon="waveform" href="/how-to/elevenlabs">
    Scribe transcribes the meeting; optional bot-layer TTS uses the same API key.
  </Card>
